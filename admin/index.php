              ...
              <div class="card">
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                        <i class="fas fa-calendar-alt text-dark text-gradient text-lg opacity-10"></i>
              ...
              <div class="card">
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                        <i class="fas fa-credit-card text-dark text-gradient text-lg opacity-10"></i>
                      </div>
                      <h5 class="text-white font-weight-bolder mb-0 mt-3">
                        2300
                      </h5>
              ...
              <div class="card">
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                        <i class="fas fa-thumbs-up text-dark text-gradient text-lg opacity-10"></i>
                      </div>
                      <h5 class="text-white font-weight-bolder mb-0 mt-3">
                        940
                      </h5>
