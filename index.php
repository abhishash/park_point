...
<head>
    ...
    <meta name="description"
        content="Parking Point is a mobile app Tailwind CSS HTML template created to help you present benefits, features and information about mobile apps in order to convince visitors to download them" />
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar fixed-top">
        <div class="container sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap">
            ...
            <a href="/parking-point/index.php">
                <img src="./images/logo/logo.png" alt="logo image" class='w-40   block'>
            </a>
            <!-- Image Logo -->
            ...
            <div class="navbar-collapse offcanvas-collapse lg:flex lg:flex-grow lg:items-center"
                ...
                <div class="dropdown">
                    <button class="dropbtn">
                        <a class="no-underline cursor-pointer" id="dropdown-trigger">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#4f46e5" class="w-5 h-5"
                                viewBox="0 0 512 512">
                                <path
                    ...
                    <div class="dropdown-content w-48 bg-white rounded-lg shadow-lg pb-2">
                        <?php
                        if (isset($_SESSION["username"])) {
                            // Access session variables
                            $user_id = $_SESSION["user_id"];
                            $username = $_SESSION["username"];
                            $name = $_SESSION["name"];  // Access the name from the session
                            $email = $_SESSION["email"];
                            $user_type = $_SESSION["user_type"];
                            ?>
                            <h5 class="px-4 pt-4 text-gray-400">Welcome🎉</h5>
                            <h6 class="px-4 text-gray-700 border-b border-0 border-solid py-1.5"> <i class="fa fa-user-circle "></i> <?php echo $name ?>
                                (<?php echo $username ?>)</h6>
                            <ul class=" p-0">
                                <li><a href="/parking-point/profile.php" class="block hover:bg-blue-50"> <i class="fa fa-user-md text-gray-800  pr-1.5" aria-hidden="true"></i> Profile</a>
                                </li>
                                <li><a href="/parking-point/settings.php" class="block hover:bg-blue-50"><i class="fa fa-cog text-gray-800  pr-1.5" aria-hidden="true"></i> Settings</a>
                                </li>
                                <li><a href="/parking-point/logout.php" class="block hover:bg-blue-50"><i class="fa fa-lock text-gray-800  pr-1.5" aria-hidden="true"></i> Logout</a>
                                </li>
                            </ul>
                            <?php
                        } else {
                            ?>
                            <h6 class="px-4 text-gray-700 border-b border-0 border-solid py-4 text-gray-600"> <i class="fa fa-id-card pr-1.5 text-gray-500" aria-hidden="true"></i> User Login </h6>
                            <ul class="pb-2 pt-2">
                                <li><a href="login.php" class="block hover:bg-blue-50 text-gray-600"><i class="fa fa-unlock-alt pr-1.5 text-gray-600" aria-hidden="true"></i> Login</a>
                                </li>
                                <li><a href="signup.php" class="block hover:bg-blue-50 text-gray-600"><i class="fa fa-user-plus pr-1.5 text-gray-600" aria-hidden="true"></i> Sign Up</a>
                                </li>
                            </ul>
                            <?php
                        }
    ...
    <header id="header" class="header py-28 text-center md:pt-36 lg:text-left xl:pt-44 xl:pb-32">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
            <div class="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
                <h1 class="h1-large mb-5">Parking Management system application</h1>
                <p class="p-large mb-8">Start getting things done together with your team based on Parking Point's
                    revolutionary management features</p>
                <a class="btn-solid-lg" href="#your-link"><i class="fab fa-apple"></i>Download</a>
                <a class="btn-solid-lg secondary" href="#your-link"><i class="fab fa-google-play"></i>Download</a>
            </div>
            <div class="xl:text-right py-48">
                <img class="inline" src="./agent/images/car.png" alt="alternative" />
            </div>
        </div> <!-- end of container -->
    ...
    <div class="pt-4 pb-14 text-center">
        <div class="container px-4 sm:px-8 xl:px-4">
            <p class="mb-4 text-gray-800 text-3xl leading-10 lg:max-w-5xl lg:mx-auto"> Parking Management system don’t
                get better than Parking Point. It’s probably the best app in the world for this purpose. Don’t hesitate
                to give it a try today and you will fall in love with it</p>
        </div> <!-- end of container -->
    </div>
    <!-- end of introduction -->
        ...
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            <div class="lg:col-span-5">
                <div class="mb-16 lg:mb-0 xl:mt-16">
                    ...
                    <p class="mb-4">Based on our team's extensive experience in developing line of business applications
        ...
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            <div class="lg:col-span-5">
                <div class="mb-16 lg:mb-0 xl:mt-16">
                    ...
                    <p class="mb-4">Get a glimpse of what this app can do for your marketing automation and understand
                        why current users are so excited when using Parking Point
    ...
    <div class="slider-1 py-32 bg-gray">
        <div class="container px-4 sm:px-8">
            <h2 class="mb-12 text-center lg:max-w-xl lg:mx-auto">What do users think about Parking Point</h2>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="italic mb-3">It's been so fun to work with Parking Point, I've managed to
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="italic mb-3">I've been searching for a tool like Parking Point for so
    ...
    <div id="pricing" class="cards-2">
        ...
        <div class="container px-4 pb-px sm:px-8">
            ...
            <p class="mb-16 text-white lg:max-w-3xl lg:mx-auto"> Our pricing plans are setup in such a way that any user
                can start enjoying Parking Point without worrying so much about costs. They are flexible and work for
                any type of industry </p>
        ...
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2">
            ...
            <div class="lg:mt-24 xl:mt-44 xl:ml-12">
                <p class="mb-9 text-gray-800 text-3xl leading-10">Team management mobile applications don’t get much
                    better than Parking Point. Download it today</p>
                <a class="btn-solid-lg" href="#your-link"><i class="fab fa-apple"></i>Download</a>
                <a class="btn-solid-lg secondary" href="#your-link"><i class="fab fa-google-play"></i>Download</a>
            </div>
        </div> <!-- end of container -->
    ...
    <div class="footer">
        <div class="container px-4 sm:px-8">
            <h4 class="mb-8 lg:max-w-3xl lg:mx-auto">Parking Point is a parking software for marketing automation and
                you can reach the team.</h4>
